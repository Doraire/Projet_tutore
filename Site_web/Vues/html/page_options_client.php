...
<body>
	...
	<div class="options">
		<ul>
			<li><a href="page_produits.php">Consulter la liste des produits</a></li>
			<li><a href="page_commande.php">Consulter mes commandes </a></li>
			<li><a href="page_livraison.php">Consulter mes livraisons</a></li>
			<li><a href="page_modif_client.php">Modifier mes informations clients</a></li>
		</ul>
	</div>
	<?php
